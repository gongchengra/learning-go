...
<html>
    ...
    <body>
		...
		<p>Please enter a command in the text box below, such as "Translate the following paragraph into Chinese," or "Write an email in French to Mr. Anderson explaining that his mattress will be delivered to his home at the end of next month due to delivery delays. We apologize for any inconvenience caused." For helpful tips on how to create concise and effective prompt guidelines, please visit <a href="https://www.writingbeginner.com/best-prompts-for-chatgpt/" target="_blank">https://www.writingbeginner.com/best-prompts-for-chatgpt/</a></p>
        <form method="post">
	...
	if r.Method == http.MethodPost {
		...
		fmt.Fprintf(w, `<br>Your input: <br><pre>%s</pre>`, input)
		fmt.Fprintf(w, `<br>AI output:<br><pre>%s</pre>`, content)
	}
}
